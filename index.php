...
<head>
    ...
    <title>Kinara Store</title>

    <meta name="keywords" content="Kinara Store" />
    <meta name="description" content="Kinara Store">
    <meta name="author" content="Kinara Store">
...
<body>
    <div class="page-wrapper">
        ...
        <main class="main">
            <section class="section section-bg section-parallax section-1" style="background-image: url('assets/images/bg-1.jpg');">
                <div class="container">
                    <div class="section-header">
                        <h1 class="section-title">FASHION SALE</h1>
                        <h2 class="section-subtitle">HOT ITEMS</h2>

                        <a href="#" class="btn btn-primary">Get the Offer</a>
                    </div><!-- End .section-header -->
                </div><!-- End .container -->
            </section><!-- End .section -->

            <section class="section section-big section-bg section-parallax section-2" style="background-image: url('assets/images/bg-2.jpg');">
                <div class="container text-right">
                    <div class="title-group">
                        <h3>New Arrivals</h3>
                        <h2>Fashion Bag<a href="#" class="btn btn-primary">Get the Offer</a></h2>
                    </div><!-- .End .title-group -->
                </div><!-- End .container -->
            ...
            <section class="section section-big section-bg section-parallax section-3" style="background-image: url('assets/images/bg-3.jpg');">
                <div class="container">
                    <div class="title-group">
                        <h3>New Arrivals</h3>
                        <h2>Fashion Kids<a href="category.html" class="btn btn-primary">Get the Offer</a></h2>
                    </div><!-- .End .title-group -->
                </div><!-- End .container -->
            ...
            <section class="section section-bg section-parallax section-4" style="background-image: url('assets/images/bg-4.jpg');">
                <div class="container text-right">
                    <div class="section-header">
                        <h2 class="section-title"><span>FAST RESPONSE</span>Connect with</h2>
                        <h3 class="section-subtitle">WHATSAPP</h3>
                        <a href="https://api.whatsapp.com/send?phone=6285722971668&text=Assalamu'alaikum%20KinaraStore" class="btn btn-primary"><i class="icon-phone"></i>085722971668</a>
                    </div><!-- End .section-header -->
                </div><!-- End .container -->
            </section><!-- End .section -->
        </main><!-- End .main -->
